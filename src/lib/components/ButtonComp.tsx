...
const ButtonComp = ({ConnectButtonComp, WrongNetworkComp, AddressBox, StyleNetworkButton, StyleIconBox, StyleIconImage,StyleAddressButton}:buttonProps) : JSX.Element=> {
